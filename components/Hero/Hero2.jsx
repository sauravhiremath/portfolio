...
const Hero = ({ about }) => {
    ...
    return (
        ...
        <div
            className='w-full lg:max-h-[100%] mx-auto bg-fixed !overflow-hidden top-0 py-10 mt-6 max-h-screen rounded-lg min-h-[35rem] min-h-[30rem]'
        // style={{
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-6 items-center ">
                ...
                <div className="col-span-1 md:col-span-4 md:space-y-2 flex flex-col">
                    ...
                    <h1 className='text-[26px] md:text-6xl  firaCode relative  text-[#222] dark:text-white' >
                        <span className='z-20 relative'>Work</span>
                        <div className="absolute bottom-0 z-10 hidden md:flex">
                            <svg width="100%" height="48px" viewBox="0 0 219 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="absolute bottom-2 z-10 md:hidden flex">
                            <svg width="100%" height="24px" viewBox="0 0 219 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M12.2274 0.321133C-0.0413398 1.58609 -1.43031 3.35678 2.04197 12.7175C5.86144 23.0901 13.8478 25.6208 75.8858 29.9216C4.24113 32.9573 -2.35631 36.4991 0.537258 48.3897C4.24102 63.3162 27.9683 61.7983 143.479 62.3042C178.086 62.5572 197.3 66.8581 207.138 65.8461C220.795 64.3282 217.439 52.6906 211.767 47.3778L214.892 46.1128C223.11 42.8239 218.133 22.0789 207.601 16.0071C198.341 10.6943 145.1 5.12797 93.826 4.116C26.0008 3.10404 26.2323 -1.19681 12.2274 0.321133Z" fill="#FAEF91" fillOpacity="0.6" />
                            </svg>
                        </div>
                    ...
                    <h1 className='text-[26px] md:text-6xl firaCode relative  text-[#222] dark:text-white' >
                        ...
                        <div className="absolute bottom-0 z-10 hidden md:flex">
                            <svg width="100%" height="48px" viewBox="0 0 202 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="absolute bottom-2 z-10 md:hidden flex">
                            <svg width="100%" height="24px" viewBox="0 0 202 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M11.2782 0.282208C-0.0381308 1.39384 -1.31928 2.9499 1.88346 11.1759C5.40644 20.2913 12.7729 22.5152 69.9952 26.2948C3.91191 28.9624 -2.1734 32.075 0.495553 42.5243C3.91181 55.6415 25.7972 54.3076 132.342 54.7522C164.262 54.9745 181.984 58.7541 191.058 57.8648C203.656 56.5308 200.56 46.3038 195.329 41.635L198.211 40.5234C205.791 37.6331 201.2 19.4027 191.486 14.0668C182.945 9.39801 133.836 4.50639 86.5427 3.61709C23.9825 2.72779 24.196 -1.05175 11.2782 0.282208Z" fill="#FA9191" fillOpacity="0.6" />
                            </svg>
                        </div>
                        <span className='ml-2 md:ml-4'>
                    ...
                    <h1 className='text-[26px] flex whitespace-nowrap md:flex-nowrap md:text-6xl firaCode  text-[#222] dark:text-white' >
                        ...
                        <div className='relative'>
                            ...
                            <div className="absolute hidden md:flex bottom-0 z-10">
                                <svg width="100%" height="58px" viewBox="0 0 421 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M23.5056 0.340596C-0.0794706 1.68222 -2.74959 3.56022 3.92543 13.4882C11.2679 24.4895 26.6207 27.1735 145.881 31.7351C8.15305 34.9547 -4.52971 38.7112 1.03281 51.3224C8.15283 67.1535 53.7655 65.5436 275.821 66.0803C342.348 66.3486 379.284 70.9101 398.196 69.8368C424.451 68.2268 417.999 55.8839 407.096 50.2491L413.104 48.9075C428.901 45.4193 419.334 23.417 399.086 16.9772C381.286 11.3424 278.936 5.43875 180.369 4.36546C49.9832 3.29216 50.4282 -1.26935 23.5056 0.340596Z" fill="#91A8FA" fillOpacity="0.6" />
                                </svg>
                            </div>
                            <div className="absolute  md:hidden flex bottom-0 z-10">
                                <svg width="100%" height="38px" viewBox="0 0 421 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M23.5056 0.340596C-0.0794706 1.68222 -2.74959 3.56022 3.92543 13.4882C11.2679 24.4895 26.6207 27.1735 145.881 31.7351C8.15305 34.9547 -4.52971 38.7112 1.03281 51.3224C8.15283 67.1535 53.7655 65.5436 275.821 66.0803C342.348 66.3486 379.284 70.9101 398.196 69.8368C424.451 68.2268 417.999 55.8839 407.096 50.2491L413.104 48.9075C428.901 45.4193 419.334 23.417 399.086 16.9772C381.286 11.3424 278.936 5.43875 180.369 4.36546C49.9832 3.29216 50.4282 -1.26935 23.5056 0.340596Z" fill="#91A8FA" fillOpacity="0.6" />
                                </svg>
                            </div>
                        </div>
                    </h1>
                    {/* <h1 className='text-3xl  md:hidden flex  whitespace-nowrap md:flex-nowrap md:text-6xl firaCode  text-[#222] dark:text-white' >
                        <span className='mr-2 '>
                            full-time
                        </span>
                        <div className='relative '>
                ...
                <div className=" col-span-2 md:min-h-[25rem] flex items-center">
                    <div className='w-full  rotate-[-25deg] md:rotate-[25deg] flex flex-col '>
                        <div className="md:hidden justify-center mr-auto flex rotate-[130deg]">
                        ...
                        <div className='flex space-x-4 items-center'>
                            ...
                            <div className='text-xl font-semibold caveat  my-6'>
                                {about.title}
                            </div>
                        </div>
                        <p className='text-lg md:text-xl font-semibold caveat max-w-[20rem] mb-4'>
                            {about.description[0]}
                        </p>
