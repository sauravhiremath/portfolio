    ...
    return (
        ...
        >
            <div className="grid relative grid-cols-1 md:grid-cols-6 items-center ">
                <div className="animation-rotate opacity-20 absolute top-[-100%] right-0">
                    <img src='/images/ellipse-white.png' />
                </div>
                <div className="col-span-1 md:col-span-4 md:space-y-2 flex flex-col">

                    <h1 className='text-[27px] md:text-6xl  firaCode relative  text-[#222] dark:text-white' >
                    ...
                    <h1 className='text-[27px] flex whitespace-nowrap md:flex-nowrap md:text-6xl firaCode  text-[#222] dark:text-white' >
                ...
                <div className="mt-[-40px] md:mt-4 col-span-2 md:min-h-[25rem] flex items-center">
                    <div className='w-full  rotate-[-25deg] md:rotate-[25deg] flex flex-col '>
                        {mounted && theme === 'light' ?
                            ...
                            <div className="md:hidden   mr-auto flex rotate-[130deg]">
                                <svg width="138" height="138" viewBox="0 0 138 138" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M30.1602 97.0416C37.0242 97.1679 51.3457 98.8862 53.3755 99.822C54.5173 100.348 55.7345 100.294 56.0123 99.6916C56.6264 98.3595 52.8006 95.9805 48.6804 95.1578C45.9433 94.5882 45.9288 94.6198 49.7141 93.7498C58.4773 91.675 73.7093 83.6605 75.4274 80.184C75.9417 79.1519 92.6194 80.7643 108.753 58.7821C113.635 52.1111 115.868 42.18 112.726 41.1545C112.189 40.9839 111.65 41.2355 111.399 41.6966L109.118 46.144C96.8687 69.8782 79.535 74.1935 79.4887 74.2106C79.5251 73.8813 83.7665 67.1837 76.7334 60.2496C73.6367 57.2068 69.2527 55.4549 65.0235 56.6203C51.4679 60.3314 52.3281 75.1496 66.2503 78.5681C68.1238 79.0088 68.2433 78.8331 64.5733 81.3715C58.2576 85.7283 47.6779 89.6577 37.4827 91.4184C33.69 92.0543 33.6924 92.1324 37.8694 88.8279C47.7351 81.1083 50.7011 75.0918 43.5965 77.239C41.9868 77.7275 41.4211 78.1204 34.8449 83.6262C32.3335 85.7372 28.3051 88.8028 25.9032 90.4259C21.4066 93.5062 21.0459 93.9551 22.1757 95.0912C23.6106 96.4834 25.4695 96.9558 30.1602 97.0416ZM61.4619 72.4378C57.9427 68.3927 61.9746 62.4831 69.494 60.604C73.2768 59.6559 75.9297 62.9941 75.2074 67.8143C74.7671 70.6879 71.9007 75.4042 70.5274 75.4634C67.3004 75.7063 63.036 74.2788 61.4619 72.4378Z" fill="white" />
                                </svg>
                            </div>
                        }
                        ...
                        <p className='text-2xl  font-semibold caveat max-w-[20rem] mb-4'>
                            {about.description[0]}
                        </p>
