        ...
        <div className='flex overflow-hidden lg:hidden'>
            ...
            >
                <div
                    ...
                    <div
                        className="min-w-[100vw] pl-8  backdrop-blur-lg  flex flex-col h-screen items-stretch py-4">
                        <div
                            onClick={() => setOpen(false)} className={`w-fit ml-auto mr-6 mt-2 mb-4  cursor-pointer flex lg:hidden   hover:rotate-180  text-darkColor dark:text-white bg-blue-100 hover:bg-blue-200 dark:hover:bg-[#333]  dark:bg-buttonDark text-lg  p-3 transition-all duration-300 rounded-full`}>
                            <RiCloseLine />
                        </div>
                        <ul className="flex flex-col text-center space-y-8">
                            {routeData.map((route, i) => (
                                <li
                                    key={i}
                                    className='w-fit dark:text-white link text-lg font-semibold relative ' onClick={() => { setOpen(false) }}>
                            ...
                            >
                                <a href="/#contact" className="relative mr-auto inline-flex text-md group">
                                    ...
                                    <span className="absolute bottom-0 right-0 w-full h-10 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-gray-900 dark:bg-gray-300 rounded-md group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-md" />
                                </a>
                            </li>
                            <li>
                                <div
                                    onClick={toggleDarkMode} className="cursor-pointer flex lg:hidden  text-lg p-3 w-fit rounded-md text-darkColor bg-blue-100 hover:bg-blue-200 dark:text-white dark:hover:bg-[#333] dark:border dark:border-[#444] dark:shadow-sm dark:bg-buttonDark dark:bg-opacity-60 dark:hover:bg-opacity-20">
                        ...
                        <ul
                            className='mt-auto  mr-auto flex space-x-3 items-center  dark:text-white'>
