...
const Projects = () => {
    ...
    return (
        <Suspense>
            <div
                style={{
                    backgroundImage: `${mounted && resolvedTheme && theme === 'light' ? 'linear-gradient(#F9FAFB,#F9FAFB)' : `url('/images/grid.png'), linear-gradient(135deg, rgba(11,36,58, 0.5), #030611 45%,  rgba(11,36,58, 0.5))`}`,
                }}
