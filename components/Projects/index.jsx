    ...
    return (
        <Waypoint onEnter={handleEnter}>
            <div className='relative'>
                ...
                <div
                    className='container bg-fixed mt-[-65vh] rounded-lg lg:py-12 overflow-hidden mx-auto space-y-16'
                >
                            ...
                            >
                                <div className='w-fit ml-auto cursor-pointer' onClick={() => setSlice(10)}>
                                    <div className="group transition-all duration-500 items-end flex space-x-2 hover:space-x-4">
                                        <p
                                            className='text-sm lg:text-base tracking-widest uppercase text-[#7e7e7e] dark:text-neutral-500 font-semibold'>View More</p>
            ...
            <div className={`${i % 2 === 1 && 'hidden'} overflow-hidden grid place-items-center grid-cols-1 md:grid-cols-2 gap-12`}>
                ...
                <div className="flex flex-col space-y-5">
                    ...
                    <div
                        data-aos="fade-left"
                        data-aos-duration="800"
                        data-aos-delay="500" className="w-fit flex uppercase group cursor-pointer hover:opacity-90 transition-all duration-500 hover:ml-2 text-[#7e7e7e] font-semibold items-center dark:text-neutral-500 text-lg lg:text-xl">
                        View Work <span className='ml-3 group-hover:ml-6 transition-all duration-500'>➞</span>
                    </div>
