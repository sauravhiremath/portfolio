...
const Python = () => {
    return (
        <>
            <a className="flex justify-center space-x-4 opacity-60 hover:opacity-100 items-center cursor-pointer">
...
const ReactLogo = () => {
    return (
        <>
            <a className="flex justify-center space-x-4 opacity-60 hover:opacity-100 items-center cursor-pointer">
                <SiReact className='!text-7xl text-white' />
            </a>
    ...
    return (
        <>
            <a className="flex justify-center space-x-4 opacity-60 hover:opacity-100 items-center cursor-pointer">
                ...
                <SiTensorflow className='!text-7xl text-white' />
...
const Golang = () => {
    return (
        <>
            <a className="flex mt-2 justify-center space-x-4 opacity-60 hover:opacity-100 space-y-[-2px] items-center cursor-pointer">
